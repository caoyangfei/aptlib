...
import com.flyang.plugin.inject.asm.IClassVisitor
import com.flyang.plugin.inject.asm.InjectClassVisitor
...
class InjectTransform extends Transform {
    ...
    private static final String NAME = "InjectTransform"
