...
abstract class AbsProcedure {
    ...
    AspectjExtensionConfig aspectJExtensionConfig
    ...
    AbsProcedure(Project project, VariantCache variantCache, TransformInvocation transformInvocation) {
        ...
        if (variantCache != null) {
            ...
            this.aspectJCache = variantCache.aspectJCache
            this.aspectJExtensionConfig = aspectJCache.aspectJExtensionConfig
        }
    }
